...
namespace Fox.Microservices.Payments
{
    public class Startup : BaseStartup
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "FOX Microservices - Payments API", Version = "v1" });
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "Fox.Microservices.Payments.xml");
